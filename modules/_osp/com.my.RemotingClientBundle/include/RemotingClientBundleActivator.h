...
class RemotingClientBundleActivator : public Poco::OSP::BundleActivator
{
	//
...
public:
	//! Constructor.
	RemotingClientBundleActivator() = default;
	//! Destructor.
	~RemotingClientBundleActivator() = default;
...
POCO_BEGIN_MANIFEST(Poco::OSP::BundleActivator)
	POCO_EXPORT_CLASS(RemotingClientBundleActivator)
POCO_END_MANIFEST